...
<?php endif; ?>
		...
		$this->assign(['page_title'=>'添加<?php echo $config['tableCnName']; ?>', 'page_name'=>'<?php echo $config['tableCnName']; ?>列表', 'page_link'=>U('lst?p='.I('get.p'))]);
		$this->display();
    }
...
<?php endif; ?>
		...
		$this->assign(['page_title'=>'修改<?php echo $config['tableCnName']; ?>',  'page_name'=>'<?php echo $config['tableCnName']; ?>列表', 'page_link'=>U('lst?p='.I('get.p'))]);
		$this->display();
    }
...
<?php endif; ?>
		...
		$this->assign(['page_title'=>'<?php echo $config['tableCnName']; ?>列表', 'page_name'=>'添加<?php echo $config['tableCnName']; ?>', 'page_link'=>U('add')]);
    	$this->display();
    }
}